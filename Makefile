...
help:
	...
	@echo "  make run WARP_FADE_VOCAL=0.0       # off — fade is constant"
	@echo "  make run WARP_FADE_VOCAL=0.75      # default — vocals shorten trails (clear-out)"
	@echo "  make run WARP_FADE_VOCAL=1.0       # vocals collapse trails to ~0.1× length"
	@echo "  make run WARP_FADE_VOCAL=-0.5      # vocals lengthen trails by ~1.5× (atmospheric)"
	@echo "  make run WARP_FADE_VOCAL=-1.0      # vocals double trails (dreamy / hyperspace bloom)"
